...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_Q,       KC_W,       KC_F,       KC_P,       KC_G,       TG(3),                               TG(4),               KC_J,       KC_L,       KC_U,       KC_Y,       KC_SCOLON,      KC_TRANSPARENT,
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, LGUI_T(KC_TAB), LALT_T(KC_DEL),                                                     LGUI_T(KC_TAB), LALT_T(KC_DEL), KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                             KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                             KC_TRANSPARENT, KC_TRANSPARENT,
                                                           LT(2,KC_SPACE), LCTL_T(KC_ESCAPE),KC_TRANSPARENT, KC_TRANSPARENT, LSFT_T(KC_ENTER),LT(1,KC_BSPACE)
  ),
  [1] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_UNDS,        KC_AT,          KC_CIRC,        KC_TILD,        KC_NO,          KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_NO,          KC_ASTR,        KC_DLR,         KC_GRAVE,       KC_BSLASH,      KC_TRANSPARENT,
  ...
  [2] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_LCBR,        KC_LBRACKET,    KC_LABK,        KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_RABK,        KC_RBRACKET,    KC_RCBR,        KC_TRANSPARENT, KC_TRANSPARENT,
    ...
    KC_TRANSPARENT, LCTL_T(KC_HOME),LSFT_T(KC_END), LCTL_T(KC_PGDOWN),LSFT_T(KC_PGUP),KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_WH_DOWN,  KC_MS_WH_UP,    KC_MS_ACCEL2,   KC_MS_ACCEL0,   KC_TRANSPARENT,
  ...
  [3] = LAYOUT_ergodox_pretty(
    ...
    KC_LCTRL,       KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,           KC_Y,                                 KC_TRANSPARENT, KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_TRANSPARENT,
    KC_RALT,         KC_H, KC_J, KC_K, KC_ESCAPE,                                                                                                      KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
